      ...
      <View style={{ flex: 1 }}>
        {isAvailable ? (
          <View style={styles.container}>
            <Text style={styles.stat}>{`${counter + 1}/${
              questions.length
            }`}</Text>

            <Text style={styles.question}>
              {answer ? questions[counter].answer : questions[counter].question}
            </Text>

            <TouchableOpacity onPress={this.answer}>
              <Text style={styles.answer}>
                {answer ? `Hide answer` : `answer`}
              </Text>
            </TouchableOpacity>
            ...
            <View style={styles.container}>
              <TouchableOpacity
                ...
                style={
                  Platform.OS === "ios"
                    ? [styles.iosSubmitBtn, { backgroundColor: green }]
              ...
              <TouchableOpacity
                ...
                style={
                  Platform.OS === "ios"
                    ? [styles.iosSubmitBtn, { backgroundColor: deeppink }]
                    : [styles.AndroidSubmitBtn, { backgroundColor: deeppink }]
                }
              >
